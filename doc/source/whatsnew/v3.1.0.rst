...
- Bug in :func:`pandas.testing.assert_series_equal` where ``check_series_type=False`` still compared concrete ``ndarray`` subclass types of the backing arrays (:issue:`65770`)
